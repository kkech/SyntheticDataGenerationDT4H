# Release Gate: DT4H_Synthetic_gaussian_copula_seed2

Evaluated 2026-08-27T12:16:57.239944+00:00
...
| coherence | FAIL | violation rate 0.28083 vs holdout baseline 0.00024 (threshold 0.01024 = max(10x baseline, baseline+0.01)) |
...
Reported, not thresholded: **96.3%** of this file's records carry at least one rule violation, against **0.8%** of the real holdout's. The coherence check above is per applicable rule-check, which is the smaller number; a release decision should be taken on both.
