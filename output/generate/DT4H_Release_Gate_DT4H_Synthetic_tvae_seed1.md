# Release Gate: DT4H_Synthetic_tvae_seed1

Evaluated 2026-08-27T12:26:51.783640+00:00
...
| coherence | FAIL | violation rate 0.02273 vs holdout baseline 0.00024 (threshold 0.01024 = max(10x baseline, baseline+0.01)) |
| distance | FAIL | 449/3520 record(s) (12.8%, privacy step (all rows, same encoder)) closer than the holdout p5 threshold (0.062785, over 249 column(s)); policy limit 10% = 2x the natural 5% share |
