# Release Gate: DT4H_Synthetic_gaussian_copula_seed0

Evaluated 2026-08-27T12:25:12.220706+00:00
...
| coherence | FAIL | violation rate 0.27696 vs holdout baseline 0.00024 (threshold 0.01024 = max(10x baseline, baseline+0.01)) |
...
Reported, not thresholded: **96.2%** of this file's records carry at least one rule violation, against **0.8%** of the real holdout's. The coherence check above is per applicable rule-check, which is the smaller number; a release decision should be taken on both.
