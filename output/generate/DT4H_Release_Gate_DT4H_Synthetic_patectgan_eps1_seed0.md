# Release Gate: DT4H_Synthetic_patectgan_eps1_seed0

Evaluated 2026-08-27T12:17:56.996330+00:00
...
| coherence | FAIL | violation rate 0.44246 vs holdout baseline 0.00024 (threshold 0.01024 = max(10x baseline, baseline+0.01)) |
...
Reported, not thresholded: **100.0%** of this file's records carry at least one rule violation, against **0.8%** of the real holdout's. The coherence check above is per applicable rule-check, which is the smaller number; a release decision should be taken on both.
